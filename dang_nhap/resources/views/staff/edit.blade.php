                ...
                <div class="col-4">
                    ...
                    <form action="{{ route('staff.update', $staffs->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="phone" class="form-control" value="{{ $staffs->phone }}">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Ngày Làm Việc</label>
                            <input name="day_working" type="date" class="form-control" value="{{ $staffs->day_working }}">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Địa Chỉ</label>
                            <input name="address" type="text" class="form-control" value="{{ $staffs->address }}">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <img src="{{ asset('public/uploads/login/' . $staffs->image) }} "height="120px" width="120px">
